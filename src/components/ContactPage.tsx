...
export const ContactPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Halo LANBON Smart Home,
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            Siap membantu mewujudkan hunian smart home impian Anda. Konsultasi gratis dengan ahli kami.
          </p>
        </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Instalasi dan Setup">Instalasi dan Setup</option>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() => window.open('https://wa.me/6281234567890?text=Halo, saya ingin konsultasi produk LANBON Smart Home', '_blank')}
